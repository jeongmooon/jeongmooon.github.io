const menus = {
  STUDY: {
    ...
    '4-WEEK': ['WEB-PROXY','PROXY-TOOL'], 
    '5-WEEK': ['SQL-INJECTION','SQL-INJECTION-CTF'], 
    '6-WEEK': ['UNION-BASED-SQL-INJECTION','ERROR-BASED-SQL-INJECTION','BLIND-BASED-SQL-INJECTION'],
    'WEBSHELL': ['FILE-UPLOAD','REVERSE-WEB-SHELL','DEVELOPER-DEFENDER'],
  },
  REPORT: {
    'REPORT1': ['LOGIN'],
